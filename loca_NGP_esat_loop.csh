        ...
        do
          ...
          mkdir -p ${CLIPPED_OUTDIR}
           ...
           #      nccopy -4 -d 8 ${INFILE}?${ALWAYS_GET_US},${INVAR}${TYX_COORDS}  ${TEMPFILE}
            ...
            echo
            echo ncap2 --history --deflate 8 --script 'temporary=round( 611. * exp((2.5e6 / 461.) * (1. / 273.15 - 1. / (273.15 + temporary))) )'  ${TEMPFILESUNPACK}  ${TEMPFILEVAPUNPACK}
                 ncap2 --history --deflate 8 --script 'temporary=round( 611. * exp((2.5e6 / 461.) * (1. / 273.15 - 1. / (273.15 + temporary))) )'  ${TEMPFILESUNPACK}  ${TEMPFILEVAPUNPACK}
            ...
            echo ncatted -h -O -a scale_factor,temporary,c,f,1.0  ${TEMPFILEVAP}
                 ncatted -h -O -a scale_factor,temporary,c,f,1.0  ${TEMPFILEVAP}
           echo
